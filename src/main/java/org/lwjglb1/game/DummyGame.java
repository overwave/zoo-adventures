...
import org.lwjglb1.engine.IGameLogic;
import org.lwjglb1.engine.MouseInput;
import org.lwjglb1.engine.Scene;
...
import org.lwjglb1.engine.graph.Renderer;
import org.lwjglb1.engine.graph.anim.AnimGameItem;
import org.lwjglb1.engine.graph.anim.Animation;
import org.lwjglb1.engine.graph.lights.DirectionalLight;
import org.lwjglb1.engine.graph.weather.Fog;
import org.lwjglb1.engine.items.GameItem;
import org.lwjglb1.engine.items.SkyBox;
import org.lwjglb1.engine.loaders.assimp.AnimMeshesLoader;
import org.lwjglb1.engine.loaders.assimp.StaticMeshesLoader;
...
public class DummyGame implements IGameLogic {
    ...
    public void init(Window window) throws Exception {
        ...
        Mesh terrainMesh = StaticMeshesLoader.load("C:\\Users\\overw\\IdeaProjects\\lwjglbook\\chapter27\\c27-p1\\src\\main\\resources\\models/terrain/terrain.obj");
        GameItem terrain = new GameItem(terrainMesh);
        terrain.setScale(100.0f);

        Mesh mesh2 = StaticMeshesLoader.load("C:\\Users\\overw\\IdeaProjects\\lwjglbook\\chapter27\\c27-p1\\src\\main\\resources\\models\\cube\\c9.obj");
        GameItem mesh22 = new GameItem(mesh2);
