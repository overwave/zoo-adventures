...
public class ShadowBuffer {
    ...
    public ShadowBuffer() {
        ...
        depthMap = new ArrTexture(Scene.SHADOW_CASCADES_NUMBER, SHADOW_MAP_WIDTH, SHADOW_MAP_HEIGHT, GL_DEPTH_COMPONENT);
    ...
    public void bindTextures(int start) {
        for (int i = 0; i < Scene.SHADOW_CASCADES_NUMBER; i++) {
